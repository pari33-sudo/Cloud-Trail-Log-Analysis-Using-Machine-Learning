...
git clone https://github.com/paripatel2907/cloudtrail-ml-analyzer.git
cd cloudtrail-ml-analyzer
...
Step-by-step setup for your environment
...
Python module and React component reference
- Function signatures
...
Complete MSc thesis documentation
- Literature survey
- System design
...
jupyter notebook notebooks/CloudTrail_ML_Analysis.ipynb
```
...
```bash
# Build Docker image
docker build -t cloudtrail-ml-analyzer .

# Run container
docker run -p 8888:8888 cloudtrail-ml-analyzer
...
See [docs/INSTALLATION.md](docs/INSTALLATION.md) for detailed AWS setup including:
...
**[⬆ Back to Top](#cloudtrail-ml-analyzer-)**

Made with ❤️ by Pari Patel

**Next Step:** [Getting Started](docs/INSTALLATION.md) • [View Examples](examples/) • [Read Full Report](docs/PROJECT_REPORT.md)
